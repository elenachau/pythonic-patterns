...
def main() -> None:
    ...
    shopping_cart.add_item(Item(name="laptop", price=150000))
    shopping_cart.add_item(Item(name="mouse", price=3000))
    shopping_cart.add_item(Item(name="keyboard", price=4000))
